...
public class FIleUploadController {
	private static final String CURR_IMAGE_REPO_PATH = "C:\\DEV\\spring\\image_repo";
	...
	private List<String> fileProcess(MultipartRequest multipartRequest) throws Exception{
